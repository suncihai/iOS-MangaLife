...
class ViewController: UIViewController {
    ...
    let FullDistance: CGFloat = 0.30
    let Proportion: CGFloat = 0.90
    ...
    override func viewDidLoad() {
        ...
        rightViewController.view.center = CGPointMake(rightViewController.view.center.x + 208, rightViewController.view.center.y - 55)
...
//        homeViewController.navigationItem.rightBarButtonItem?.action = Selector("showRight")
    ...
    func pan(recongnizer: UIPanGestureRecognizer) {
        ...
        let pro2 = 0.8 + (proportionOfRightView - 0.8) * trueProportion
    ...
    func doTheAnimate(proportion: CGFloat, showWhat: String) {
        UIView.animateWithDuration(0.3, delay: 0, options: UIViewAnimationOptions.CurveEaseInOut, animations: { () -> Void in
            ...
            if showWhat == "right" {
                // 移动左侧菜单的中心
                self.rightViewController.view.center = CGPointMake(self.centerOfRightViewAtBeginning.x + self.distanceOfLeftView, self.rightViewController.view.center.y)
                // 缩放左侧菜单
